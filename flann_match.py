    ...
    def find_matches(self):
        ...
        for glm_img_path in glm_images:
            ...
            for abi_img_path in abi_images:
                ...
                matches = flann.knnMatch(glm_descriptors, glm_descriptors, k=2)
                ...
                img3 = cv2.drawMatchesKnn(
                    glm_img, glm_keypoints, abi_img, abi_keypoints, matches, None, **draw_params)
                ...
                if len(good_matches) > 0:
                    mean_distance = np.mean(
                        [match.distance for match in good_matches])
            ...
            if best_match is not None:
                ...
                matched_img = cv2.drawMatches(
                    matched_abi_img, abi_keypoints, glm_img, glm_keypoints, good_matches, None)
                ...
                glm_points = [
                    glm_keypoints[m.trainIdx].pt for m in good_matches]
                abi_points = [
                    abi_keypoints[m.queryIdx].pt for m in good_matches]
